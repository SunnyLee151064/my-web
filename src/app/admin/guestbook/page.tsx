      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', marginBottom: '2rem' }}>
          <button
            ...
            style={{
              padding: '0.5rem 1rem',
              background: filter === 'all' ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'rgba(0, 0, 0, 0.15)',
              color: 'white',
          ...
          <button
            ...
            style={{
              padding: '0.5rem 1rem',
              background: filter === 'pending' ? 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)' : 'rgba(0, 0, 0, 0.15)',
              color: 'white',
              border: '1px solid rgba(0, 0, 0, 0.2)',
              borderRadius: '20px',
              cursor: 'pointer',
          ...
          <button
            ...
            style={{
              padding: '0.5rem 1rem',
              background: filter === 'approved' ? 'linear-gradient(135deg, #4ecdc4 0%, #44a08d 100%)' : 'rgba(0, 0, 0, 0.15)',
              color: 'white',
              border: '1px solid rgba(0, 0, 0, 0.2)',
              borderRadius: '20px',
              cursor: 'pointer',
